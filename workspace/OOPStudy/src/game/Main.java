...
public class Main {
   ...
   Main(){
	   ...
	   items[5] = new Item("가죽갑옷",0,0,10,30);
	   items[6] = new Item("체력주머니",50,0,10,0);
	   items[7] = new Item("마나주머니",0,50,10,0);
	   ...
	   monsters[0] = new Monster("바위게",20,20,10,10,50,
			   new Item[] {items[0],items[1],items[2],items[3]});

	   monsters[1] = new Monster("협곡의전령",100,20,50,50,100,
			   new Item[] {items[4],items[5],items[6],items[7]});
	   
	   monsters[2] = new Monster("바론",5000,2000,200,200,400,
			   new Item[] {items[0],items[1],items[2],items[3]});
   }
